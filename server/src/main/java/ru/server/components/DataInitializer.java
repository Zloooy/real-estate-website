...
public class DataInitializer implements ApplicationRunner {
    ...
    private static final List<String>
            ...
            authorityNames = Arrays.asList(Authority.CAN_ENTER, Authority.CAN_VIEW_ROLES, Authority.CAN_MANAGE_USERS, Authority.CAN_EDIT_ARTICLES,  Authority.CAN_EDIT_COMPLEXES, Authority.CAN_EDIT_FLATS, Authority.CAN_EDIT_METROS, Authority.CAN_EDIT_DISTRICTS),
